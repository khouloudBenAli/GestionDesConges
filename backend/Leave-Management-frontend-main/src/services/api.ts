...
export const departmentApi = {
  ...
  getEmployees: (id: number): Promise<AxiosResponse<Employee[]>> =>
    api.get(`/employees/department/${id}`),
  create: (data: DepartmentDto): Promise<AxiosResponse<Department>> =>
    api.post('/departments', data),
  update: (id: number, data: DepartmentDto): Promise<AxiosResponse<Department>> =>
...
export const employeeApi = {
  ...
  update: (id: number, data: EmployeeDto): Promise<AxiosResponse<Employee>> =>
  ...
  assignDepartment: (employeeId: number, deptId: number): Promise<AxiosResponse<Employee>> =>
    api.put(`/employees/${employeeId}/assign-department/${deptId}`),
  search: (keyword: string): Promise<AxiosResponse<Employee[]>> =>
    api.get('/employees/search', { params: { keyword } }),
}
...
export const leaveTypeApi = {
  ...
  create: (data: LeaveTypeDto): Promise<AxiosResponse<LeaveType>> =>
    api.post('/leave-types', data),
  update: (id: number, data: LeaveTypeDto): Promise<AxiosResponse<LeaveType>> =>
...
export const leaveBalanceApi = {
  ...
  getForYear: (employeeId: number, year: number): Promise<AxiosResponse<LeaveBalance[]>> =>
    api.get(`/leave-balances/employee/${employeeId}/year/${year}`),
  getSpecific: (employeeId: number, typeId: number, year: number): Promise<AxiosResponse<LeaveBalance>> =>
    api.get(`/leave-balances/employee/${employeeId}/leave-type/${typeId}/year/${year}`),
...
export const leaveRequestApi = {
  ...
  getById: (id: number): Promise<AxiosResponse<LeaveRequest>> =>
  ...
  getByStatus: (status: string): Promise<AxiosResponse<LeaveRequest[]>> =>
    api.get(`/leave-requests/status/${status}`),
